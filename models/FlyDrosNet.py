...
cnn_model = Model(inputs=inputs, outputs=CB, name='FlyDrosNet')
...
checkpoint_filepath = '../weights/FlyDrosNet_weights.h5'
...
cnn_model.load_weights("../weights/FlyDrosNet_weights.h5")
...
open('../weights/FlyDrosNet_8bit_weights.tflite', 'wb').write(tflite_model)
interpreter = tf.lite.Interpreter(model_path='../weights/FlyDrosNet_8bit_weights.tflite')
...
savemat("../data/FlyDrosNet_perf.mat",  to_mat)
sns.set()
plt.figure()
